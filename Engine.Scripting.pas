...
uses
  ...
  Scripting.Serialization, Scripting.Context;

type
  TEngineScriptTargetKind = Scripting.Serialization.TEngineScriptTargetKind;
  TEngineScriptExecutionResult = Scripting.Serialization.TEngineScriptExecutionResult;
  TEngineScriptAsset = Scripting.Serialization.TEngineScriptAsset;
  TEngineScriptPrefabLoadCallback = Scripting.Context.TEngineScriptPrefabLoadCallback;
  TEngineScriptPrefabDestroyCallback = Scripting.Context.TEngineScriptPrefabDestroyCallback;
  TEngineScriptLogCallback = Scripting.Context.TEngineScriptLogCallback;
  TEngineScriptSceneFileCallback = Scripting.Context.TEngineScriptSceneFileCallback;
  TEngineScriptShutdownCallback = Scripting.Context.TEngineScriptShutdownCallback;
  TEngineScriptContext = Scripting.Context.TEngineScriptContext;

const
  stkGlobal = Scripting.Serialization.stkGlobal;
  stkSceneObject = Scripting.Serialization.stkSceneObject;
  stkShader = Scripting.Serialization.stkShader;
  stkMaterial = Scripting.Serialization.stkMaterial;
  stkRenderTechnique = Scripting.Serialization.stkRenderTechnique;
